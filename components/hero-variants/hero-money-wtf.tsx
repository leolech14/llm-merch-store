      ...
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div>
          <h1 className="font-black tracking-tight leading-[0.95]">
            <span className="block text-4xl md:text-6xl lg:text-7xl line-through decoration-white/70 decoration-8 opacity-50 text-white/50">
              talk shit
            </span>
            <span className="block text-4xl md:text-6xl lg:text-7xl opacity-100 text-white mt-2">
              make money
            </span>
          </h1>
